...
const UserForm =()=>{
    ...
    const SendSms = async () => {
        try{
            ...
            if (isAvailable) {
                let smsResponse = await SMS.sendSMSAsync(
                    ["0941841996"],
                    "Hey Braz"
                    );
...
const inputStyle=StyleSheet.create({
  ...
  <Card.Cover source={{ uri: 'data:image/png;base64,' }} />
    ...
    />
     ...
     <Button mode='contained' color='green' style={{marginTop:20}}
      onPress={()=>{
        setHome(true);
      }}
        >Register</Button>
      </Card.Content>
  </Card>):<SplashScreen userName={name} email={email} phone={phone}/>}
  </>
}
